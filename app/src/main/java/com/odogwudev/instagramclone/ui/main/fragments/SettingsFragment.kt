...
import com.odogwudev.instagramclone.ui.main.viewmodels.SettingsViewModel
import com.odogwudev.instagramclone.ui.slideUpViews
...
class SettingsFragment : Fragment(R.layout.fragment_settings) {
    ...
    private fun subscribeToObservers() {
        viewModel.getUserStatus.observe(viewLifecycleOwner, Event.EventObserver(
            onError = {
        ...
        viewModel.updateProfileStatus.observe(viewLifecycleOwner, Event.EventObserver(
            onError = {
                settingsProgressBar.isVisible = false
                snackbar(it)
                btnUpdateProfile.isEnabled = true

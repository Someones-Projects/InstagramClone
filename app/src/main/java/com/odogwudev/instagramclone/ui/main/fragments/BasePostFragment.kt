...
import com.odogwudev.instagramclone.adapters.PostAdapter
import com.odogwudev.instagramclone.adapters.UserAdapter
import com.odogwudev.instagramclone.others.Event
import com.odogwudev.instagramclone.ui.main.dialogs.DeletePostDialog
import com.odogwudev.instagramclone.ui.main.dialogs.LikedByDialog
...
abstract class BasePostFragment(
    ...
    private fun subscribeToObservers() {
        ...
        basePostViewModel.likePostStatus.observe(viewLifecycleOwner, Event.EventObserver(
            onError = {
        ...
        basePostViewModel.likedByUsers.observe(viewLifecycleOwner, Event.EventObserver(
            onError = {
                snackbar(it)
            }
        ) { users ->

...
import com.odogwudev.instagramclone.data.entities.Comment
import com.odogwudev.instagramclone.data.entities.Post
import com.odogwudev.instagramclone.data.entities.ProfileUpdate
import com.odogwudev.instagramclone.data.entities.User
import com.odogwudev.instagramclone.others.Constants.DEFAULT_PROFILE_PICTURE_URL
    ...
    override suspend fun toggleFollowForUser(uid: String) = withContext(Dispatchers.IO) {
        safeCall {
            ...
            firestore.runTransaction { transaction ->
                ...
                val currentUser = transaction.get(users.document(uid)).toObject(User::class.java)!!
